...
\begin{propriete}
Au cours d'une \imp{transformation \abr{qs}} --- la système étant toujours infiniment proche d'un état d'équilibre --- toutes les grandeurs d'état à l'intérieur du système ($P$, $T$, \ldots) sont définies à tout moment.
\end{propriete}
