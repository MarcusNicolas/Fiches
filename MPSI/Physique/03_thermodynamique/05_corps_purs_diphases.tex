...
\begin{definition}
On appelle \tdef{diagramme de Clapeyron} (resp. \tdef{diagramme de Watt}) la représentation de la pression $P$ d'un fluide en fonction de son volume massique $v$ (resp. de son volume $V$).
\end{definition}
