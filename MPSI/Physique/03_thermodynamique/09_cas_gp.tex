...
\begin{propriete}
L'\imp{entropie} $S^{\text{\abr{gp}}}$ d'un \imp{\abr{gp}} est une :
...
\begin{theoreme}
Un \imp{\abr{gp}} de coefficient $\gamma$ \imp{constant} et soumis aux \imp{seules forces de pression} subissant une transformation \imp{isentropique} ou bien à la fois \imp{adiabatique} et \imp{\abr{qs}} vérifie les \tdef{relations de Laplace} (équivalentes entre elles) :
...
\begin{propriete}
Dans un \imp{diagramme de Watt}, une adiabatique \abr{qs} d'un \imp{\abr{gp}} décroît plus rapidement qu'une isotherme partant du même point :
