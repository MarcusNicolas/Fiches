...
\begin{definition}
On appelle \tdef{thermostat} (ou \tdef{source de chaleur}) un système \imp{fermé} échangeant de l'énergie avec l'extérieur \imp{uniquement sous forme de transfert thermique}, et ce \imp{sans que sa température ne varie}.
\end{definition}
...
\begin{propriete}
Pour un système en contact seuelement avec des \imp{thermostats} :
